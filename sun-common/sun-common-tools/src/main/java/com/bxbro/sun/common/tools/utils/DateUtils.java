...
public class DateUtils {
    ...
    /**
     * 功能:yyyy_MM_dd_HH_mm_ss格式的日期字符串, 最早时间
     * @param date
     * @return
     */
    public static String getStringTimeEarliest(Date date) {
        return format(date) + " 00:00:00";
    }

    /**
     * 功能:yyyy_MM_dd_HH_mm_ss格式的日期字符串, 最晚时间
     * @param date
     * @return
     */
    public static String getStringTimeDateLatest(Date date) {
     ...
     * @return
     */
    public static Date getTimetampToDate(String timetamp) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Long time = Long.parseLong(timetamp);
        String timeDate = format.format(time * 1000L);
        Date date = stringToDate(timeDate, DATE_TIME_PATTERN);
        return date;
    }
     ...
     * @return
     */
    public static String getTimetampToStringDate(String timetamp) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Long time = Long.parseLong(timetamp);
        String timeDate = format.format(time * 1000L);
        return timeDate;
