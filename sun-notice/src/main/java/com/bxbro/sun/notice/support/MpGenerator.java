...
public class MpGenerator {
     ...
     * 数据库连接url
     */
    private static String dbUrl="jdbc:mysql://121.4.162.107:3306/sun?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/sun-notice/src/main/java");
        ...
        pc.setParent("com.bxbro.sun.notice");
        pc.setEntity("entity");
        pc.setMapper("mapper");
...
//         tc.setService("...");
        ...
        //目录设置修改
        pathInfo.put(ConstVal.XML_PATH, projectPath + "/sun-notice/src/main/resources/mapper/");
        mpg.execute();
    }
}
